...
export function App(): JSX.Element {
  ...
  // Player-facing level picker. Lets players jump to any already-unlocked
  // level to replay it and beat their best time; levels they haven't reached
  // yet stay locked (see isLevelUnlocked), so this can't be used to skip ahead.
